...
scanAgain:
	...
	case isLetter(ch):
		...
		// BLOOD LOCK: Pembantaian Ekstrem Keyword Go
		switch lit {
		case "func":
			s.error(s.offset, "FATAL: 'func' is forbidden in 0xg. Use 'def'.")
			return pos, token.ILLEGAL, lit
		case "package":
			s.error(s.offset, "FATAL: 'package' is forbidden in 0xg. Use 'cabinet'.")
			return pos, token.ILLEGAL, lit
		case "import":
			s.error(s.offset, "FATAL: 'import' is forbidden in 0xg. Use 'require ... retain'.")
			return pos, token.ILLEGAL, lit
		case "var":
		...
		case "switch":
			...
			return pos, token.ILLEGAL, lit
		case "chan":
			s.error(s.offset, "FATAL: 'chan' is forbidden in 0xg. Use 'Channel(T)'.")
			return pos, token.ILLEGAL, lit
		case "range":
			s.error(s.offset, "FATAL: 'range' is forbidden in 0xg. Use 'for ... in'.")
			return pos, token.ILLEGAL, lit
		case "interface":
			s.error(s.offset, "FATAL: 'interface' is forbidden in 0xg. Use 0xg OOP constructs.")
			return pos, token.ILLEGAL, lit
		case "map":
			s.error(s.offset, "FATAL: lowercase 'map' is forbidden in 0xg. Use 'Map(K, V)'.")
			return pos, token.ILLEGAL, lit
		case "string":
			s.error(s.offset, "FATAL: lowercase 'string' is forbidden in 0xg. Use 'String'.")
			return pos, token.ILLEGAL, lit
		case "int", "int8", "int16", "int32", "int64":
			s.error(s.offset, "FATAL: lowercase built-in types are forbidden in 0xg. Use 'Int', 'Int8', etc.")
			return pos, token.ILLEGAL, lit
		case "uint", "uint8", "uint16", "uint32", "uint64":
			s.error(s.offset, "FATAL: lowercase built-in types are forbidden in 0xg. Use 'Uint', 'Uint8', etc.")
			return pos, token.ILLEGAL, lit
		case "float32", "float64":
			s.error(s.offset, "FATAL: lowercase built-in types are forbidden in 0xg. Use 'Float32', 'Float64'.")
			return pos, token.ILLEGAL, lit
		case "bool":
			s.error(s.offset, "FATAL: lowercase 'bool' is forbidden in 0xg. Use 'Bool'.")
			return pos, token.ILLEGAL, lit
		case "byte":
			s.error(s.offset, "FATAL: lowercase 'byte' is forbidden in 0xg. Use 'Byte'.")
			return pos, token.ILLEGAL, lit
		case "rune":
			s.error(s.offset, "FATAL: lowercase 'rune' is forbidden in 0xg. Use 'Rune'.")
			return pos, token.ILLEGAL, lit
		case "any":
			s.error(s.offset, "FATAL: lowercase 'any' is forbidden in 0xg. Use 'Any' or union types.")
			return pos, token.ILLEGAL, lit
		case "try", "catch", "rescue":
			s.error(s.offset, "FATAL: try/catch/rescue blocks are forbidden in 0xg. Use 'if err'.")
			return pos, token.ILLEGAL, lit
		case "ensure", "finally":
			s.error(s.offset, "FATAL: ensure/finally blocks are forbidden in 0xg. Use 'defer'.")
			return pos, token.ILLEGAL, lit
		}
		...
		if len(lit) > 1 {
			...
			switch tok {
			case token.IDENT, token.FALLTHROUGH, token.RETURN, token.YIELD:
				insertSemi = true
			}
		} else {
			insertSemi = true
	...
	default:
		...
		case ':':
			if s.ch == ':' {
				...
				if tok == token.DEFINE {
					s.error(s.offset, "FATAL: ':=' is forbidden in 0xg. Use 'let' for declaration or empty assignment for reassign.")
					tok = token.ILLEGAL
				}
			}
		case '.':
